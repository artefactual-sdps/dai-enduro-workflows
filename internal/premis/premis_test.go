  ...
  <premis:event>
    ...
    <premis:eventOutcomeInformation>
      ...
      <premis:eventOutcomeDetail>
        <premis:eventOutcomeDetailNote>The SIP metadata is valid</premis:eventOutcomeDetailNote>
      </premis:eventOutcomeDetail>
    </premis:eventOutcomeInformation>
    <premis:linkingAgentIdentifier>
      ...
      <premis:linkingAgentIdentifierValue>https://github.com/artefactual-sdps/dai-enduro-workflows</premis:linkingAgentIdentifierValue>
    </premis:linkingAgentIdentifier>
  </premis:event>
  <premis:agent>
...
func TestOriginalNameForSubpath(t *testing.T) {
	...
	assert.Equal(t, premis.OriginalNameForSubpath("cat.jpg"), "data/cat.jpg")
	assert.Equal(t, premis.OriginalNameForSubpath("metadata/metadata.csv"), "data/metadata/metadata.csv")
}
